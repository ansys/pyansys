...
.. grid:: 3
    ...
    .. grid-item-card:: PyAdditive Widgets
      :img-top: _static/thumbnails/intro.png
      :link: https://widgets.additive.docs.pyansys.com/version/0.2/getting_started/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyAnsys Geometry
      ...
      :link: https://geometry.docs.pyansys.com/version/0.6/user_guide/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyAnsys Sound
      ...
      :link: https://sound.docs.pyansys.com/version/0.1/user_guide.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDPF - Core
      ...
      :link: https://dpf.docs.pyansys.com/version/0.12/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Post
      :img-top: _static/thumbnails/pydpf-post.png
      :link: https://post.docs.pyansys.com/version/0.8/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Composites
      :img-top: _static/thumbnails/pydpf-composites.png
      :link: https://composites.dpf.docs.pyansys.com/version/0.5/intro.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDyna
      :img-top: _static/thumbnails/pydyna.png
      :link: https://dyna.docs.pyansys.com/version/0.4/user-guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDynamicReporting
      :img-top: _static/thumbnails/pydynamicreporting.png
      :link: https://dynamicreporting.docs.pyansys.com/version/0.6/userguide/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyEDB - Core
      :img-top: _static/thumbnails/pyedb.png
      :link: https://edb.core.docs.pyansys.com/version/0.1/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyEnSight
      :img-top: _static/thumbnails/pyensight.png
      :link: https://ensight.docs.pyansys.com/version/0.8/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyFluent
      :img-top: _static/thumbnails/pyfluent.png
      :link: https://fluent.docs.pyansys.com/version/0.22/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyFluent - Visualization
      :img-top: _static/thumbnails/pyfluent-visualization.png
      :link: https://visualization.fluent.docs.pyansys.com/version/0.11/users_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyGranta
      :img-top: _static/thumbnails/pygranta.png
      :link: https://grantami.docs.pyansys.com/version/2024.2/user_guide.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyHPS
      :img-top: _static/thumbnails/intro.png
      :link: https://hps.docs.pyansys.com/version/0.8/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMAPDL
      :img-top: _static/thumbnails/pymapdl.png
      :link: https://mapdl.docs.pyansys.com/version/0.68/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMAPDL Reader
      :img-top: _static/thumbnails/pymapdl.png
      :link: https://reader.docs.pyansys.com/version/0.53/user_guide/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyModelCenter
      ...
      :link: https://modelcenter.docs.pyansys.com/version/0.1/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMotorCAD
      :img-top: _static/thumbnails/pymotorcad.png
      :link: https://motorcad.docs.pyansys.com/version/0.5/user_guide/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyPIM
      :img-top: _static/thumbnails/intro.png
      :link: https://pypim.docs.pyansys.com/version/1.1/index.html#getting-started
      :class-title: pyansys-card-title

    .. grid-item-card:: PyPrimeMesh
      :img-top: _static/thumbnails/pyprimemesh.png
      :link: https://prime.docs.pyansys.com/version/0.6/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PyRocky
      :img-top: _static/thumbnails/pyrocky.png
      :link: https://rocky.docs.pyansys.com/version/0.2/user_guide/index.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySherlock
      ...
      :link: https://sherlock.docs.pyansys.com/version/0.6/user_guide/index.html
      :class-title: pyansys-card-title

    .. grid-item-card:: PySimAI
      :img-top: _static/thumbnails/pysimai.png
      :link: https://simai.docs.pyansys.com/version/0.2/user_guide.html
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyTwin
      ...
      :link: https://twin.docs.pyansys.com/version/0.7/user_guide/index.html
      :class-title: pyansys-card-title
