...
.. grid:: 3
    ...
    .. grid-item-card:: PyDynamicReporting
      ...
      :link: https://dynamicreporting.docs.pyansys.com/version/0.4/userguide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMAPDL Reader
      :img-top: _static/thumbnails/pymapdl.png
      :link: https://reader.docs.pyansys.com/version/0.52/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySherlock
      ...
      :link: https://sherlock.docs.pyansys.com/version/0.2/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
