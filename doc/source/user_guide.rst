...
.. grid:: 3
    ...
    .. grid-item-card:: PyAdditive
      ...
      :link: https://additive.docs.pyansys.com/version/0.17/getting_started/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyAEDT
      :img-top: _static/thumbnails/pyaedt.png
      :link: https://aedt.docs.pyansys.com/version/0.7/User_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyAnsys Geometry
      :img-top: _static/thumbnails/pyansys-geometry.png
      :link: https://geometry.docs.pyansys.com/version/0.4/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDPF - Core
      ...
      :link: https://dpf.docs.pyansys.com/version/0.10/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Post
      :img-top: _static/thumbnails/pydpf-post.png
      :link: https://post.docs.pyansys.com/version/0.6/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Composites
      :img-top: _static/thumbnails/pydpf-composites.png
      :link: https://composites.dpf.docs.pyansys.com/version/0.3/intro.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDynamicReporting
      ...
      :link: https://dynamicreporting.docs.pyansys.com/version/0.5/userguide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyFluent - Parametric
      ...
      :link: https://parametric.fluent.docs.pyansys.com/version/0.9/users_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyFluent - Visualization
      :img-top: _static/thumbnails/pyfluent-visualization.png
      :link: https://visualization.fluent.docs.pyansys.com/version/0.8/users_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMechanical
      ...
      :link: https://mechanical.docs.pyansys.com/version/0.10/index.html#background
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyOptislang
      ...
      :link: https://optislang.docs.pyansys.com/version/0.5/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySystemCoupling
      ...
      :link: https://systemcoupling.docs.pyansys.com/version/0.3/users_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyTwin
      ...
      :link: https://twin.docs.pyansys.com/version/0.6/user_guide/index.html
      :text-align: center
      :class-title: pyansys-card-title
