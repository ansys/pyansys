...
.. grid:: 3
    ...
    .. grid-item-card:: PyAEDT
      ...
      :link: https://aedt.docs.pyansys.com/version/0.6/API/index.html
      :text-align: center
    ...
    .. grid-item-card:: PyMAPDL
      ...
      :link: https://mapdl.docs.pyansys.com/version/0.64/api/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMAPDL Reader
      :img-top: _static/thumbnails/pymapdl.png
      :link: https://reader.docs.pyansys.com/version/0.52/api/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMechanical
      :img-top: _static/thumbnails/pymechanical.png
      :link: https://mechanical.docs.pyansys.com/version/0.8/api/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyMotorCAD
      :img-top: _static/thumbnails/pymotorcad.png
      :link: https://motorcad.docs.pyansys.com/version/0.1/methods/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyOptislang
      :img-top: _static/thumbnails/pyoptislang.png
      :link: https://optislang.docs.pyansys.com/version/0.2/api/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyTwin
      ...
      :link: https://twin.docs.pyansys.com/version/0.3/api/index.html
      :text-align: center
      :class-title: pyansys-card-title
