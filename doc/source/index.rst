...
.. grid:: 3
    ...
    .. grid-item-card:: PyDPF - Composites
      ...
      :link: https://composites.dpf.docs.pyansys.com/version/0.4
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyHPS
      :img-top: _static/thumbnails/intro.png
      :link: https://hps.docs.pyansys.com/version/0.7
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyOptislang
      ...
      :link: https://optislang.docs.pyansys.com/version/0.6
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySimAI
      :img-top: _static/thumbnails/intro.png
      :link: https://simai.docs.pyansys.com/version/0.1
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySystem Coupling
      ...
      :link: https://systemcoupling.docs.pyansys.com/version/0.4
      :text-align: center
      :class-title: pyansys-card-title
