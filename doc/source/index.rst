...
.. grid:: 3
    ...
    .. grid-item-card:: PyAEDT
      ...
      :link: https://aedt.docs.pyansys.com/version/0.6
      :text-align: center
    ...
    .. grid-item-card:: PyDPF-Core
      ...
      :link: https://dpf.docs.pyansys.com/version/0.8
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDPF-Post
      ...
      :link: https://post.docs.pyansys.com/version/0.4
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDPF Composites
      ...
      :link: https://composites.dpf.docs.pyansys.com/version/0.2
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyFluent-Parametric
      ...
      :link: https://parametric.fluent.docs.pyansys.com/version/0.7
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyFluent-Visualization
      ...
      :link: https://visualization.fluent.docs.pyansys.com/version/0.7
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMAPDL
      ...
      :link: https://mapdl.docs.pyansys.com/version/0.64
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMAPDL Reader
      :img-top: _static/thumbnails/pymapdl.png
      :link: https://reader.docs.pyansys.com/version/0.52
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMechanical
      ...
      :link: https://mechanical.docs.pyansys.com/version/0.8
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMotorCAD
      ...
      :link: https://motorcad.docs.pyansys.com/version/0.1
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyOptislang
      ...
      :link: https://optislang.docs.pyansys.com/version/0.2
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySeascape
      :img-top: _static/thumbnails/intro.png
      :link: https://seascape.docs.pyansys.com/version/0.1
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyTwin
      ...
      :link: https://twin.docs.pyansys.com/version/0.3
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: Granta MI BoM Analytics
      :img-top: _static/thumbnails/intro.png
      :link: https://bomanalytics.grantami.docs.pyansys.com/version/1.1
      :text-align: center
      :class-title: pyansys-card-title
...
.. grid:: 3
    ...
    .. grid-item-card:: Shared Components
      ...
      Shared Ansys software components to enable package interoperability and minimize maintenance
>>>>>>> 9a481f9 (Update title of the composites plugin of DPF (and align other names) (#303))
