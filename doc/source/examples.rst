...
.. grid:: 3
    ...
    .. grid-item-card:: PyAdditive
      ...
      :link: https://additive.docs.pyansys.com/version/0.17/examples/gallery_examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyAEDT
      :img-top: _static/thumbnails/pyaedt.png
      :link: https://aedt.docs.pyansys.com/version/0.7/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyAnsys Geometry
      :img-top: _static/thumbnails/pyansys-geometry.png
      :link: https://geometry.docs.pyansys.com/version/0.4/examples.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDPF - Core
      ...
      :link: https://dpf.docs.pyansys.com/version/0.10/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Post
      :img-top: _static/thumbnails/pydpf-post.png
      :link: https://post.docs.pyansys.com/version/0.6/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyDPF - Composites
      :img-top: _static/thumbnails/pydpf-composites.png
      :link: https://composites.dpf.docs.pyansys.com/version/0.3/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyDynamicReporting
      ...
      :link: https://dynamicreporting.docs.pyansys.com/version/0.5/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyFluent - Parametric
      ...
      :link: https://parametric.fluent.docs.pyansys.com/version/0.9/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyFluent - Visualization
      :img-top: _static/thumbnails/pyfluent-visualization.png
      :link: https://visualization.fluent.docs.pyansys.com/version/0.8/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title

    .. grid-item-card:: PyGranta
      :img-top: _static/thumbnails/intro.png
      :link: https://grantami.docs.pyansys.com/version/2024.1/examples.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyMechanical
      ...
      :link: https://mechanical.docs.pyansys.com/version/0.10/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PyOptislang
      ...
      :link: https://optislang.docs.pyansys.com/version/0.5/examples/index.html
      :text-align: center
      :class-title: pyansys-card-title
    ...
    .. grid-item-card:: PySherlock
      ...
      :link: https://sherlock.docs.pyansys.com/version/0.4/getting_started/index.html
      :text-align: center
      :class-title: pyansys-card-title
